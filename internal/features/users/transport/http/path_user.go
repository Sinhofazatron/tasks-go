...
import (
	...
	core_http_request "github.com/Sinhofazatron/tasks-go/internal/core/transport/http/request"
	core_http_response "github.com/Sinhofazatron/tasks-go/internal/core/transport/http/response"
	core_http_types "github.com/Sinhofazatron/tasks-go/internal/core/transport/http/types"
)
	...
	if r.PhoneNumber.Set {
		if r.PhoneNumber.Value != nil {
			...
			if !strings.HasPrefix(*r.PhoneNumber.Value, "+") {
				return fmt.Errorf("`phone_number` must starts with '+' symbol")
			}
		}
	}
...
func (h *UsersHTTPHandler) PatchUser(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		responseHandler.ErrorResponse(err, "faied to patch user")
		return
	}
